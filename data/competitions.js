// ============================================================
//  科展資訊分頁的資料。
//  competitions:各大競賽。name / grades / blurb / when 皆分三語(tw/en/cn),
//    url 與 id / cat 為共用。⚠️ 不要把中文塞進共用欄位,否則會出現在英文頁。
...
export const ui = {
  tw: {
    ...
    cats: { national: "全國級指標賽事", elite: "菁英競賽與獎助", regional: "州 / 區域科展" },
  ...
  en: {
    ...
    cats: { national: "Top National Competitions", elite: "Elite Competitions & Scholarships", regional: "State / Regional Fairs" },
  ...
  cn: {
    ...
    cats: { national: "全国级标杆赛事", elite: "精英竞赛与奖助", regional: "州 / 区域科展" },
...
export const competitions = [
  {
    id: "isef", cat: "national",
    name: { tw: "Regeneron ISEF", en: "Regeneron ISEF", cn: "Regeneron ISEF" },
    grades: { tw: "9–12 年級", en: "Grades 9–12", cn: "9–12 年级" },
  ...
  {
    id: "sts", cat: "national",
    name: { tw: "Regeneron Science Talent Search (STS)", en: "Regeneron Science Talent Search (STS)", cn: "Regeneron Science Talent Search (STS)" },
    grades: { tw: "高中畢業班(12 年級)", en: "Grade 12 (seniors)", cn: "高中毕业班(12 年级)" },
  ...
  {
    id: "jshs", cat: "national",
    name: { tw: "Junior Science & Humanities Symposium (JSHS)", en: "Junior Science & Humanities Symposium (JSHS)", cn: "Junior Science & Humanities Symposium (JSHS)" },
    grades: { tw: "9–12 年級", en: "Grades 9–12", cn: "9–12 年级" },
  ...
  {
    id: "jic", cat: "national",
    name: { tw: "Thermo Fisher JIC(原 Broadcom MASTERS)", en: "Thermo Fisher JIC (formerly Broadcom MASTERS)", cn: "Thermo Fisher JIC(原 Broadcom MASTERS)" },
    grades: { tw: "6–8 年級(中學)", en: "Grades 6–8 (middle school)", cn: "6–8 年级(中学)" },
  ...
  {
    id: "davidson", cat: "elite",
    name: { tw: "Davidson Fellows Scholarship", en: "Davidson Fellows Scholarship", cn: "Davidson Fellows Scholarship" },
    grades: { tw: "18 歲以下", en: "Under 18", cn: "18 岁以下" },
  ...
  {
    id: "think", cat: "elite",
    name: { tw: "MIT THINK Scholars", en: "MIT THINK Scholars", cn: "MIT THINK Scholars" },
    grades: { tw: "9–12 年級", en: "Grades 9–12", cn: "9–12 年级" },
  ...
  {
    id: "conrad", cat: "elite",
    name: { tw: "Conrad Challenge", en: "Conrad Challenge", cn: "Conrad Challenge" },
    grades: { tw: "6–12 年級", en: "Grades 6–12", cn: "6–12 年级" },
  ...
  {
    id: "genius", cat: "elite",
    name: { tw: "GENIUS Olympiad", en: "GENIUS Olympiad", cn: "GENIUS Olympiad" },
    grades: { tw: "高中", en: "High school", cn: "高中" },
  ...
  {
    id: "affiliated", cat: "regional",
    name: { tw: "你所在地區的 ISEF 加盟科展", en: "ISEF-Affiliated Fair (your region)", cn: "你所在地区的 ISEF 加盟科展" },
    grades: { tw: "依各賽事", en: "Varies by fair", cn: "依各赛事" },

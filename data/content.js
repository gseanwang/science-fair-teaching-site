  ...
  cn: {
    ...
    faculty: {
      ...
      members: [
        ...
        {
          name: "李中杰 兽医师", nameEn: "Dr. Jay Lee", role: "动物科学・生命科学导师",
          ...
          groups: [
            ...
            { title: "学历与双执照", points: ["国立台湾大学 兽医学士 + 护理学士", "兽医师、护理师 双国考执照", "台大书卷奖(班级前 5%)两度、宠物营养学 A+"] },
            { title: "适合带的科展方向", points: ["动物健康、疾病与诊断", "生理、营养与动物行为", "分子生物与细胞学入门"] },
          ],
          awards: ["兽医师・护理师 双国考执照", "台大书卷奖(班级前 5%)两度得主", "TOEIC 910 金色证书"],
        },
      ],
    },
    contact: {
  ...
  tw: {
    ...
    faculty: {
      ...
      members: [
        ...
        {
          name: "李中傑 獸醫師", nameEn: "Dr. Jay Lee", role: "動物科學・生命科學導師",
          ...
          groups: [
            ...
            { title: "學歷與雙執照", points: ["國立臺灣大學 獸醫學士 + 護理學士", "獸醫師、護理師 雙國考執照", "臺大書卷獎(班級前 5%)兩度、寵物營養學 A+"] },
            { title: "適合帶的科展方向", points: ["動物健康、疾病與診斷", "生理、營養與動物行為", "分子生物與細胞學入門"] },
          ],
          awards: ["獸醫師・護理師 雙國考執照", "臺大書卷獎(班級前 5%)兩度得主", "TOEIC 910 金色證書"],
        },
      ],
    },
    contact: {
      ...
      members: [
        ...
        },
        {
          ...
          groups: [
            ...
            { title: "Education & Dual Licenses", points: ["B.V.M. + B.Nursing, National Taiwan University", "Licensed Veterinarian & Registered Nurse (Taiwan)", "Two-time NTU Presidential Award (top 5%); A+ in Clinical Pet Nutrition"] },
          ...
          awards: ["Licensed Veterinarian & Registered Nurse (Taiwan)", "Two-time NTU Presidential Award (top 5%)", "TOEIC 910 Gold Certificate"],
        },
      ],
    },
    contact: {

      ...
      members: [
        {
          ...
          groups: [
            ...
            { title: "应用研究与推广", points: ["UF/IFAS EDIS 萝卜病害推广文章(即将发表)", "农委会技术支援专员:撰写 4 份整合病虫害管理(IPM)技术手册", "田间试验与种子处理实务"] },
      ...
      members: [
        {
          ...
          groups: [
            ...
            { title: "應用研究與推廣", points: ["UF/IFAS EDIS 蘿蔔病害推廣文章(即將發表)", "農委會技術支援專員:撰寫 4 份整合病蟲害管理(IPM)技術手冊", "田間試驗與種子處理實務"] },
      ...
      members: [
        {
          ...
          groups: [
            ...
            { title: "Applied Research & Extension", points: ["UF/IFAS EDIS carrot-disease extension article (forthcoming)", "Ministry of Agriculture (Taiwan): authored 4 IPM technical bulletins", "Field trials & seed-treatment practice"] },
